...
<div id="navcon">
   ...
   Contact
    ...
    <a onClick={() => handlePageChange('Pastwork')}><button  class="bg-black pop hover:bg-gray-800 text-gray-500 hover:text-gray-400 py-2 px-4 border border-gray-500 hover:border-transparent rounded text-base font-light mx-24 platformbuttons">
    Portfolio
    </button></a>
